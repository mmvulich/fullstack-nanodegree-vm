...
def findARestaurant(mealType,location):
    ...
    mealTypeString = mealType.replace(' ', '+')
    url = ('https://api.foursquare.com/v2/venues/search?client_id=%s&client_secret=%s&v=20130815&ll=%s,%s&query=%s' % (foursquare_client_id, foursquare_client_secret, coordinates['lat'], coordinates['lng'], mealTypeString))
    h=httplib2.Http()
